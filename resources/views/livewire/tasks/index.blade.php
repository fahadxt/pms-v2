<div
	class="flex-1 overflow-y-auto transition
	duration-500 ease-in-out">
		...
		{{-- <div class="mt-1 mb-4 flex items-center justify-between">
			...
			<div class="flex items-center select-none">
				<span class="flex hover:text-pink-500 cursor-pointer mr-3">
			...
			<div class="flex flex-row mb-4">
				<div
					...
					<div class="flex">
						...
						<!-- User image -->
						<div class="flex flex-col flex-none w-20 break-words text-center break-all items-center ">
							<img
								class="h-12 w-12 rounded-full object-cover"
								src="{{ asset( $value->assignedTo->profile_photo_url ) }}"
								alt="User Avatar" 
							/>
							<span class="text-lg font-bold">{{ $value->assignedTo->name }}</span>
						</div>
						...
						<div class="flex flex-col mr-6">								
							...
							<div class="mt-4">
								<div>
									...
									<p>
										Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi perspiciatis, temporibus veniam, ipsam ipsa id rem, placeat rerum harum optio fugit voluptatum. Maxime vero eum dignissimos autem. A, labore tenetur?
										Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi perspiciatis, temporibus veniam, ipsam ipsa id rem, placeat rerum harum optio fugit voluptatum. Maxime vero eum dignissimos autem. A, labore tenetur?
										Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi perspiciatis, temporibus veniam, ipsam ipsa id rem, placeat rerum harum optio fugit voluptatum. Maxime vero eum dignissimos autem. A, labore tenetur?
										Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi perspiciatis, temporibus veniam, ipsam ipsa id rem, placeat rerum harum optio fugit voluptatum. Maxime vero eum dignissimos autem. A, labore tenetur?
										Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi perspiciatis, temporibus veniam, ipsam ipsa id rem, placeat rerum harum optio fugit voluptatum. Maxime vero eum dignissimos autem. A, labore tenetur?
