                ...
                <div class="column">
                    <div class="new_card box-shadow">
                        ...
                        <div class="flex">
                            ...
                            <div class="st-col ">
                                <p>{{__('Today')}}</p>
                                <h3 id="today_project" class="primary">
                                    {{$projects->where('created_at' , '>=' , $dt)->count()}}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="new_card box-shadow">
                        ...
                        <div class="flex">
                            ...
                            <div class="st-col ">
                                <p>{{__('Today')}}</p>
                                <h3 id="today_tasks" class="primary">{{$tasks->where('due_on' , '=' , $dt)->count()}}
                                </h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column">
                    <div class="new_card box-shadow">
                        ...
                        <div class="flex">
                            ...
                            <div class="st-col ">
                                <p>{{__('Today')}}</p>
                                <h3 id="today_users" class="primary">
                                    {{$tasks->where('due_on' , '=' , $dt)->where('status_id' , 4)->count()}}</h3>
                            </div>
                        </div>
                    </div>
                </div>
