<x-app-layout>
    ...
    <div class="lg:flex lg:items-start color-primary">
        <div
            class="w-full lg:w-1/5 lg:px-6 text-xl text-grey-darkest leading-normal pt-8 lg:pt-16 pl-8 bg-gradient-to-b from-gray-100 to-white transition-all duration-300 h-96">
